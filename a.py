...
def main():
    cursor = "0"
    source = "6716701977205046126"

    num=12710//10
    for i in range(0, num):
        time.sleep(1)
        baseurl = "https://coral.qq.com/article/5963120294/comment/v2?callback=_article5963120294commentv2&orinum=10&oriorder=o&pageflag=1&cursor=" + cursor + "&scorecursor=0&orirepnum=2&reporder=o&reppageflag=1&source=132&_=" + source
        ua(uapools)
